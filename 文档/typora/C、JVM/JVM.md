...
<strong style="color:red">基于标记-清除算法的CMS收集器面临空间碎片过多时</strong>
...
已经没有任何字符串对象引用
常量池中的“java”常量，且虚拟机中也没有其他地方引用这个字面量
...
解决对象跨代引用，避免将整个老年代加入GC roots的扫描范围。
...
## 9.10 G1(Garbage First)回收期 区域化分代式
...
![image-20210625163156134](D:\myself\springboot-example\文档\typora\images\jvm63.png)
